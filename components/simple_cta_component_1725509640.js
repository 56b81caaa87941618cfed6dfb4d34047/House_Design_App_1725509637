...
-->
<template>
    <section id="cta-component" style="min-height: 510px"  class="bg-gradient-to-br from-pink-500 to-purple-700 flex-1 min-h-screen flex items-center justify-center">
